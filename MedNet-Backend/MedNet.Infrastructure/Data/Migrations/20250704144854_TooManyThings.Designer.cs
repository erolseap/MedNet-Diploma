...
namespace MedNet.Infrastructure.Data.Migrations
{
    ...
    [Migration("20250704144854_TooManyThings")]
    partial class TooManyThings
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MedNet.Domain.Entities.Answer", b =>
                {
                    ...
                    b.HasIndex("ParentQuestionId", "IsCorrect")
                        .IsUnique()
                        .HasDatabaseName("ix_answers_parent_question_id_is_correct");
            ...
            modelBuilder.Entity("MedNet.Domain.Entities.Question", b =>
                {
                    ...
                    b.HasIndex("ParentQuestionsSetId", "Body")
                        .IsUnique()
                        .HasDatabaseName("ix_questions_parent_questions_set_id_body");
